 ...
 * NEW FEATURES:
 * 
 * Check if we need to skip the login screen, if so go to the select language screen,
 * and after choosing the flag goes to the main screen
 * 
...
define(['userData', 'popup'], function(userData, popup) {
    ...
    // variable to check if we login screen needed
    var SKIP_LOGIN=true;
